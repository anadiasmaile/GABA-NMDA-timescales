"""
Source code for osl_dynamics.analysis.spectral modified so that
when computing the power sprectrum the median is taken across time
instead of the mean (line 1478)
"""
...
def _welch_spectrogram(
    ...
    if calc_cpsd:
        ...
        for i in range(n_windows):
            ...
            # Average the cross spectra for each sub-window
            P[i] = np.median(XX_sub_window, axis=0) # change package source code
